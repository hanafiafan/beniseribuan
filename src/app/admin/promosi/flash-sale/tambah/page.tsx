    ...
    <div className="pb-32 px-4 sm:px-0">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 mb-10 mt-6 sm:mt-0">
        <div className="flex items-center gap-5">
          ...
          <div>
            <h1 className="text-2xl sm:text-3xl font-black text-slate-900 font-heading tracking-tight">Setup Campaign</h1>
            <p className="text-xs sm:text-sm text-slate-500 font-medium mt-0.5">Konfigurasi event flash sale baru Anda.</p>
          </div>
        </div>
        <button 
        ...
        >
          ...
          {saving ? 'Saving...' : 'Launch Flash Sale'}
        </button>
      </div>
